...
pub const ISIZEABLE_STREAM: TUID = tuid(0x04F9549E, 0xE02F4E6E, 0x87E86A87, 0x47F4E17F);
pub const ISTREAM_ATTRIBUTES: TUID = tuid(0xD6CE2FFC, 0xEFAF4B8C, 0x9E74F1BB, 0x12DA44B4);
...
pub const ICOMPONENT_HANDLER2: TUID = tuid(0xF040B4B3, 0xA36045EC, 0xABCDC045, 0xB4D5A2CC);
pub const ICOMPONENT_HANDLER_BUS_ACTIVATION: TUID =
    tuid(0x067D02C1, 0x5B4E274D, 0xA92D90FD, 0x6EAF7240);
pub const IUNIT_HANDLER: TUID = tuid(0x4B5147F8, 0x4654486B, 0x8DAB30BA, 0x163A3C56);
pub const IUNIT_HANDLER2: TUID = tuid(0xF89F8CDF, 0x699E4BA5, 0x96AAC9A4, 0x81452B01);
pub const IUNIT_INFO: TUID = tuid(0x3D4BD6B5, 0x913A4FD2, 0xA886E768, 0xA5EB92C1);
