  ...
  <div class="settings-sections">
    <section class="settings-section">
      <header class="section-header">
        ...
        <div>
          ...
          <p>The name shown throughout the workspace and recent project list.</p>
        </div>
      </header>
    ...
    <section class="settings-section">
      <header class="section-header">
        ...
        <div>
          <h2>Meter and audio basis</h2>
          <p>
            Tempo is edited on the Tempo Track; these values define new media and the initial
            musical meter.
          </p>
        </div>
      </header>
    ...
    <section class="settings-section">
      <header class="section-header">
        ...
        <div>
          ...
          <p>Choose how multichannel audio is represented inside timeline clips.</p>
        </div>
      </header>
      <div class="field-grid">
        <label class="field wide">
          ...
          <select
            ...
            @change="
              update({
                waveformDisplayMode: textValue(
                  $event
                ) as ProjectConfiguration['waveformDisplayMode']
              })
            "
          >
...
.section-header {
  ...
  background: linear-gradient(90deg, #151c29, #101720);
}
.section-header > span {
  padding-top: 3px;
  color: var(--accent);
...
.section-header h2 {
  margin: 0;
  font: 560 15px var(--font-display);
}
.section-header p {
  margin: 6px 0 0;
