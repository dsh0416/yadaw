...
<style scoped>
.routing-inspector{min-width:0;overflow-y:auto;border-left:1px solid var(--line-soft);background:#0f151f;color:var(--text-primary)}.routing-inspector>header{position:sticky;z-index:3;top:0;display:grid;grid-template-columns:1fr auto;align-items:center;padding:14px 13px 12px;border-bottom:1px solid var(--line-strong);background:#111722}.routing-inspector>header span,.routing-inspector>header strong{display:block;grid-column:1}.routing-inspector>header span{color:var(--accent);font:700 7px var(--font-utility);letter-spacing:.17em}.routing-inspector>header strong{margin-top:4px;overflow:hidden;font-family:var(--font-display);font-size:13px;text-overflow:ellipsis;white-space:nowrap}.routing-inspector>header button{grid-column:2;grid-row:1/3;display:grid;place-items:center;width:27px;height:27px;padding:0;border:1px solid #3b3140;border-radius:4px;color:#ba7883;background:#20151c;cursor:pointer}.routing-inspector section{display:grid;gap:9px;padding:13px;border-bottom:1px solid #222b39}.identity-section{grid-template-columns:1fr 42px}.routing-inspector label{display:grid;gap:5px;color:#6d798c;font:7px var(--font-utility);letter-spacing:.05em}.routing-inspector label>span{display:flex;justify-content:space-between}.routing-inspector label b{color:#b2bdce;font-weight:500}.routing-inspector input:not([type=range]),.routing-inspector select{min-width:0;height:29px;padding:0 7px;border:1px solid #303b4e;border-radius:4px;color:#ccd2dd;background:#0b111a;font-size:8px}.routing-inspector input[type=color]{width:100%;padding:3px}.routing-inspector input[type=range]{width:100%;accent-color:var(--accent)}.section-heading{display:flex;align-items:center;justify-content:space-between;color:var(--accent);font:700 7px var(--font-utility);letter-spacing:.14em}.section-heading b{color:#59667b;font-size:6px}.input-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px}.send-section{align-content:start}.send-card{display:grid;gap:8px;padding:9px;border:1px solid #2b3546;border-radius:5px;background:#111824}.send-card-head{display:grid;grid-template-columns:auto 1fr auto;gap:5px}.send-card-head button,.send-mode button,.add-send button{display:flex;align-items:center;justify-content:center;gap:3px;height:25px;padding:0 6px;border:1px solid #354054;border-radius:3px;color:#78869a;background:#151e2a;font:700 6px var(--font-utility);cursor:pointer}.send-card-head button.enabled{border-color:#4f8b82;color:#8fe5d6;background:#18322f}.send-card-head select{height:25px}.send-mode{display:grid;grid-template-columns:1fr 1fr;gap:4px}.send-mode button.active{border-color:#756dd5;color:#dedbff;background:#302d60}.add-send{display:grid;grid-template-columns:1fr auto;gap:5px}.add-send select{height:27px}.empty-copy{margin:8px 0;color:#59667a;font-size:8px;line-height:1.5}.clear-clips{margin:13px;width:calc(100% - 26px);height:29px;border:1px solid #303b4e;border-radius:4px;color:#8d99aa;background:#151d28;font-size:8px;cursor:pointer}.routing-inspector button:focus-visible,.routing-inspector select:focus-visible,.routing-inspector input:focus-visible{outline:2px solid var(--focus);outline-offset:1px}
</style>
