...
<style scoped>
.studio-workspace{display:grid;grid-template-rows:34px minmax(0,1fr);min-width:0;min-height:0;background:#090d14;overflow:hidden}.workspace-switcher{display:flex;align-items:center;gap:3px;padding:0 7px;border-bottom:1px solid var(--line-strong);background:#0e141e}.workspace-switcher>span{flex:1}.workspace-switcher button{display:flex;align-items:center;gap:5px;height:25px;padding:0 8px;border:1px solid transparent;border-radius:4px;color:#657287;background:transparent;font-size:7px;cursor:pointer}.workspace-switcher button:hover{color:#bac3d0;background:#171f2b}.workspace-switcher button.active{border-color:#3e4860;color:#e0e3ec;background:#20283a;box-shadow:0 1px 0 #ffffff0a inset}.workspace-switcher button:focus-visible{outline:2px solid var(--focus);outline-offset:1px}.arrangement-mode{position:relative;display:flex;min-width:0;min-height:0;flex-direction:column}.arrangement-mode>:first-child{min-height:120px;flex:1}.mixer-dock{flex:none}.dock-resizer{position:relative;z-index:8;flex:none;height:5px;margin-top:-2px;border-top:1px solid #344056;border-bottom:1px solid #121824;background:#20293a;cursor:ns-resize}.dock-resizer::after{content:"";position:absolute;top:1px;left:50%;width:32px;height:1px;transform:translateX(-50%);background:#68758a}.dock-resizer.active{background:#343b69}
</style>
