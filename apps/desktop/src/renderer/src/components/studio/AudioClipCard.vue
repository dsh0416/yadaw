...
function startDrag(event: DragEvent): void {
  ...
  const dragImage = (event.currentTarget as HTMLElement)
    .querySelector<HTMLElement>(".transparent-drag-image")
