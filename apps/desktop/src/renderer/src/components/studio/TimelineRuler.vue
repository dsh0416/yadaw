...
<style scoped>
.ruler{position:relative;height:43px;overflow:hidden;border-bottom:1px solid var(--line-strong);background:var(--daw-ruler);cursor:text;user-select:none}.ruler::after{position:absolute;top:16px;right:0;left:0;height:1px;background:var(--line-soft);content:""}.bar-mark{position:absolute;top:16px;bottom:0;min-width:28px;padding:8px 0 0 7px;border-left:1px solid var(--daw-grid-line);color:var(--text-muted);font:8px var(--font-utility);pointer-events:none}.bar-mark::after{position:absolute;top:15px;left:25%;width:1px;height:4px;background:var(--daw-grid-line);box-shadow:7px 0 var(--daw-grid-line),14px 0 var(--daw-grid-line);content:""}
</style>
