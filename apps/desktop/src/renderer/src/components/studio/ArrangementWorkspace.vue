    ...
    <div class="timeline-grid">
      <div class="timeline-rail" :style="railStyle">
        ...
        <button
          ...
          :aria-label="`${track.name}, Alt+Arrow Up or Down to reorder`"
