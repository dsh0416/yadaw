...
<style>
.performance-trigger{display:flex;align-items:center;height:20px;padding:0 7px;border:1px solid transparent;border-radius:4px;gap:8px;color:#69768a;background:transparent;font:7px var(--font-utility);letter-spacing:.04em;cursor:pointer}.performance-trigger:hover{border-color:var(--line-strong);color:var(--text-secondary);background:#151c28}.performance-trigger:focus-visible,.refresh-performance:focus-visible{outline:2px solid var(--focus);outline-offset:2px}.performance-trigger.warning{border-color:#604d2c;color:#e8b75f;background:#211c13}.performance-trigger.critical{border-color:#65303d;color:#ff8c9b;background:#25141a}.health-light{width:5px;height:5px;border-radius:50%;background:var(--signal-cyan);box-shadow:0 0 6px #67d9e799}.warning .health-light{background:var(--warning);box-shadow:0 0 7px #e8b75faa}.critical .health-light{background:var(--record);box-shadow:0 0 7px #ff6577bb}
.performance-popover{z-index:100;width:520px;max-width:calc(100vw - 24px);max-height:calc(100vh - 48px);overflow:auto;padding:0;border:1px solid var(--line-strong);border-radius:10px;outline:none;color:var(--text-primary);background:#0e141e;box-shadow:0 24px 64px #000d;transform-origin:var(--reka-popover-content-transform-origin);animation:performance-surface-in 120ms ease-out}.performance-header{position:sticky;z-index:2;top:0;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:13px 15px;border-bottom:1px solid var(--line-soft);background:#151c28ee;backdrop-filter:blur(10px)}.performance-header>div:first-child>span,.performance-header>div:first-child>strong{display:block}.performance-header>div:first-child>span{color:var(--accent);font:700 7px var(--font-utility);text-transform:uppercase;letter-spacing:.16em}.performance-header>div:first-child>strong{margin-top:4px;font-size:11px}.performance-header-actions{display:flex;align-items:center;gap:7px}.health-badge{padding:4px 7px;border:1px solid #32636b;border-radius:4px;color:var(--signal-cyan);background:#14282d;font:7px var(--font-utility);text-transform:uppercase;letter-spacing:.08em}.health-badge.warning{border-color:#6b5631;color:#efc46e;background:#2b2418}.health-badge.critical{border-color:#713442;color:#ff9baa;background:#301820}.refresh-performance{display:grid;place-items:center;width:24px;height:24px;padding:0;border:1px solid var(--line-strong);border-radius:5px;color:var(--text-muted);background:#101722;cursor:pointer}.refresh-performance:hover{color:var(--text-primary);background:#1b2432}.refresh-performance:disabled{cursor:wait;opacity:.55}.spinning{animation:monitor-spin .8s linear infinite}
.performance-alerts{display:grid;padding:8px;border-bottom:1px solid var(--line-soft);gap:5px;background:#0c1119}.performance-alert{display:grid;grid-template-columns:15px minmax(0,1fr);align-items:start;padding:7px 8px;border:1px solid #4d422e;border-radius:6px;gap:7px;color:#e8b75f;background:#211d16}.performance-alert.critical{border-color:#673746;color:#ff7d8f;background:#291820}.performance-alert div{min-width:0}.performance-alert strong,.performance-alert span{display:block}.performance-alert strong{font-size:8px}.performance-alert span{margin-top:3px;color:#9b9284;font-size:7px;line-height:1.45}.performance-alert.critical span{color:#ac8992}
.performance-section{padding:12px 15px;border-bottom:1px solid var(--line-soft)}.section-heading{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}.section-heading>div{display:flex;align-items:center;gap:7px;color:var(--text-secondary)}.section-heading strong{font-size:9px}.section-heading>span{color:var(--text-faint);font:7px var(--font-utility);text-transform:uppercase;letter-spacing:.06em}.core-bank{display:grid;grid-template-columns:repeat(auto-fit,minmax(30px,1fr));gap:5px}.core-channel{display:grid;grid-template-rows:10px 46px 10px;justify-items:center;gap:4px;min-width:0}.core-value,.core-label{color:var(--text-faint);font:6px var(--font-utility)}.core-meter{position:relative;width:9px;height:46px;overflow:hidden;border:1px solid #2d3848;border-radius:2px;background:repeating-linear-gradient(to top,#151d29 0,#151d29 4px,#0d131c 4px,#0d131c 6px)}.core-meter i{position:absolute;right:0;bottom:0;left:0;height:var(--core-load);background:linear-gradient(to top,#4cbfca,#78dce6);box-shadow:0 0 7px #67d9e766}.core-channel.warning .core-meter i{background:var(--warning);box-shadow:0 0 7px #e8b75f88}.core-channel.critical .core-meter i{background:var(--record);box-shadow:0 0 7px #ff657799}.core-channel.warning .core-value{color:var(--warning)}.core-channel.critical .core-value{color:var(--record)}.monitor-placeholder{padding:15px;border:1px dashed var(--line-strong);border-radius:6px;color:var(--text-faint);font-size:8px;text-align:center}
.memory-readout{display:grid;grid-template-columns:minmax(0,1fr) repeat(3,auto);align-items:center;gap:10px}.linear-meter{height:6px;overflow:hidden;border:1px solid #2d3848;border-radius:2px;background:#090e16}.linear-meter i{display:block;height:100%;background:linear-gradient(90deg,var(--accent),var(--signal-cyan));box-shadow:0 0 8px #67d9e766}.memory-readout>span{color:var(--text-faint);font:7px var(--font-utility)}.storage-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.storage-space{min-width:0;padding:9px 10px;border:1px solid var(--line-soft);border-radius:6px;background:#111823}.storage-space>span,.storage-space>strong,.storage-space>small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.storage-space>span{color:var(--text-faint);font:7px var(--font-utility);text-transform:uppercase;letter-spacing:.07em}.storage-space>strong{margin-top:5px;color:var(--text-secondary);font:9px var(--font-utility)}.storage-space>small{margin-top:4px;color:#596579;font-size:7px}.storage-space.warning{border-color:#5e4b2b;background:#201b13}.storage-space.warning>strong{color:var(--warning)}.storage-space.critical{border-color:#673746;background:#28171f}.storage-space.critical>strong{color:var(--record)}
.audio-timing-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin:0;gap:6px}.audio-timing-grid>div{min-width:0;padding:8px;border:1px solid var(--line-soft);border-radius:5px;background:#101722}.audio-timing-grid dt{color:var(--text-faint);font-size:7px}.audio-timing-grid dd{margin:4px 0 0;color:#b9eaf0;font:8px var(--font-utility);white-space:nowrap}.audio-timing-grid .warning{border-color:#5e4b2b}.audio-timing-grid .warning dd{color:var(--warning)}.threshold-note{padding:8px 15px;color:#4f5a6d;background:#0a1018;font:6px var(--font-utility);line-height:1.5}.performance-popover-arrow{fill:var(--line-strong)}
