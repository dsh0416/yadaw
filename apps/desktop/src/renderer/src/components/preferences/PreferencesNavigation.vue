...
<template>
  <aside class="prefs-primary-nav">
    ...
    <nav class="settings-primary-nav" aria-label="Preference categories">
      ...
      ><component :is="category.icon" :size="15" /><span>{{ category.label }}</span><small v-if="category.disabled">SOON</small></button>
    </nav>
...
<style scoped>
.prefs-primary-nav{position:relative;min-width:0;padding:24px 11px;border-right:1px solid var(--line-soft);background:var(--surface-panel)}.prefs-secondary-nav{min-width:0;padding:24px 11px;border-right:1px solid var(--line-soft);background:var(--surface-1)}.sidebar-label{margin:0 9px 10px;color:var(--text-faint);font:700 7px var(--font-utility);letter-spacing:.16em}.settings-primary-nav{display:grid;gap:3px}.settings-nav-item{display:grid;grid-template-columns:17px 1fr auto;align-items:center;width:100%;gap:8px;padding:9px;border:1px solid transparent;border-radius:6px;color:var(--text-muted);background:transparent;text-align:left;font-size:9px;cursor:pointer}.settings-nav-item.active{border-color:color-mix(in srgb,var(--accent) 28%,transparent);color:var(--text-primary);background:var(--surface-active);box-shadow:2px 0 0 var(--accent) inset}.settings-nav-item:disabled{opacity:.42;cursor:default}.settings-nav-item small{color:var(--text-faint);font:6px var(--font-utility);letter-spacing:.08em}.sidebar-version{position:absolute;right:20px;bottom:18px;left:20px;color:var(--text-faint);font:6px var(--font-utility);letter-spacing:.06em}.secondary-sidebar-heading{margin:0 9px 17px}.secondary-sidebar-heading span,.secondary-sidebar-heading strong{display:block}.secondary-sidebar-heading span{color:var(--accent);font:700 7px var(--font-utility);letter-spacing:.17em}.secondary-sidebar-heading strong{margin-top:6px;color:var(--text-primary);font-family:var(--font-display);font-size:14px}.settings-page-item{display:grid;grid-template-columns:18px minmax(0,1fr);width:100%;gap:8px;margin-bottom:5px;padding:10px;border:1px solid transparent;border-radius:7px;color:var(--text-muted);background:transparent;text-align:left;cursor:pointer}.settings-page-item.active{border-color:var(--line-strong);color:var(--text-primary);background:var(--surface-active)}.settings-page-item>svg{margin-top:1px;color:var(--accent)}.settings-page-item b,.settings-page-item small{display:block}.settings-page-item b{font-size:9px}.settings-page-item small{margin-top:4px;color:var(--text-faint);font-size:7px;line-height:1.4}.settings-page-item:focus-visible{outline:2px solid var(--focus);outline-offset:1px}.signal-route{display:flex;align-items:center;justify-content:center;gap:5px;margin:24px 8px;color:var(--text-faint);font:6px var(--font-utility)}.signal-route i{width:16px;height:1px;background:var(--line-strong)}
</style>
