...
impl<'factory, 'services> DocumentSession<'factory, 'services> {
    ...
    /// Returns the stable opaque plug-in controller reference used by companion-format binding.
    pub fn controller_ref(&self) -> ara2_bridge_sys::ARADocumentControllerRef {
